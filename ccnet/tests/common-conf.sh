...
top_srcdir=/home/forth/projets/seafile/seafile-1.7.0-wip/ccnet

ccnet=${top_srcdir}/net/daemon/ccnet
ccnet_server=${top_srcdir}/net/server/ccnet-server
ccnet_cserver=${top_srcdir}/net/cluster/ccnet-cserver
ccnet_applet=${top_srcdir}/gui/gtk/ccnet-applet
